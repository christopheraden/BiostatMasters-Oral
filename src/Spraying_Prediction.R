...
bigTrain2011_2013$WnvPresent = bigTrain2011_2013$NumMosquitos = bigTrain2011_2013$Date = bigTrain2011_2013$Trap = NULL
...
SprayModelLM = formula(.outcome ~ . + as.factor(Species) + as.factor(Year) + as.factor(Month) + as.factor(NearbySprays>0) -Month -Cool -Species -Year -NearbySprays)
...
save(list = ls()[grep("fit", ls())], file="out/SprayFits.Rdata")